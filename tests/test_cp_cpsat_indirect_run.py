...
from flowshop_tardiness.cp_cpsat_indirect_prec import CpCpsatIndirectPrec
...
def test_cp_cpsat_indirect_prec_runs_and_builds_schedule():
    ...
    horizon = 100000
    model = CpCpsatIndirectPrec.from_instance(instance, horizon)
